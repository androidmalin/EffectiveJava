...
public class Test {
    ...
    //具体原型
    private static class ConcretePrototypeB implements IPrototype<ConcretePrototypeB> {
    ...
    //具体原型
    private static class ConcretePrototypeA implements IPrototype<ConcretePrototypeA> {
        private String desc;
